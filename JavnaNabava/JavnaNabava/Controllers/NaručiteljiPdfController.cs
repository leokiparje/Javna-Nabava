...
{
    /// <summary>
    ///Pomoćni kontroler za ispis popisa naručitelja u pdf-u
    /// </summary>
    public class NaručiteljiPdfController : Controller
    {
        private readonly RPPP06Context ctx;
        private readonly IWebHostEnvironment environment;
        private const string ExcelContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";

        public NaručiteljiPdfController(RPPP06Context ctx, IWebHostEnvironment environment)
        {
            this.ctx = ctx;
